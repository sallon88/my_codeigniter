...
<body>
	<div id="login">
		<div id="login_header">
			<h1 class="login_logo">
				<a href="http://demo.dwzjs.com"><img src="{$res}/themes/default/images/login_logo.gif" /></a>
			</h1>
		...
		<div id="login_content">
			<div class="loginForm">
				<form action="{$url}/login" method="post">
					...
					<p>
						<label>验证码：</label>
						<input class="code" type="text" name="captcha" size="5" />
						<span><img src="{$res}/images/captcha.php" alt="" width="75" height="24" /></span>
					</p>
					<div class="login_bar">
